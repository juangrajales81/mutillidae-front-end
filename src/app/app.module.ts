...
@NgModule({
  ...
  imports: [
    ...
    RouterModule.forRoot([
      ...
      { path:'toggle-security', component: ToggleSecurityComponent },
      { path:'drop-tls', component: DropTlsComponent },
      { path:'reset-db', component: ResetDbComponent },
      { path:'view-log', component: ViewLogComponent },
      { path:'captured-data', component: CapturedDataComponent },
      { path:'getting-started', component: GettingStartedComponent },
      { path:'what-should-i-do', component: WhatShouldIDoComponent },
      { path:'help-me', component: HelpMeComponent },
      { path:'video-tutorials', component: VideoTutorialsComponent },
      { path:'listing-of-vulnerabilities', component: ListingOfVulnerabilitiesComponent },
      { path:'helpful-hints-and-scripts', component: HelpfulHintsAndScriptsComponent },
      { path:'donate', component: DonateComponent },
      { path:'mutillidae-ldif-file', component: MutillidaeLdifFileComponent },
